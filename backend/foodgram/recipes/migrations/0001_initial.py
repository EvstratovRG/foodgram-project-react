# Generated by Django 3.2.3 on 2023-09-17 08:35
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', models.SmallIntegerField(validators=[django.core.validators.MaxValueValidator(1000)])),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(db_index=True, max_length=50, unique=True, verbose_name='Название рецепта')),
                ...
                ('is_favorited', models.BooleanField(verbose_name='является ли избранным')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recipe', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='recipes.recipe', verbose_name='тэг')),
            ],
            options={
                'verbose_name': 'Тэг',
